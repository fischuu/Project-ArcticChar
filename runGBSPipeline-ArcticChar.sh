...
#awk 'BEGIN {FS=","; OFS="\t"} {print $8"+"$6, $1 ,"NO"}' | tail -n +2 > /scratch/project_2003491/ArcticChar/barcodesID_Geno19.txt

#cat /scratch/project_2003491/ArcticChar/barcodesID_Geno18.txt /scratch/project_2003491/ArcticChar/barcodesID_Geno19.txt > /scratch/project_2003491/ArcticChar/barcodesID.txt
#cut -f2 /scratch/project_2003491/ArcticChar/barcodesID.txt > /scratch/project_2003491/ArcticChar/samples
